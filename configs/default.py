...
coarse_model_and_render = dict(
    num_voxels=304000,           # expected number of voxel
    num_voxels_base=304000,      # to rescale delta distance
    ...
    rgbnet_bg_depth=3,               # depth of the colors MLP_bg (there are rgbnet_depth-1 intermediate features)
    rgbnet_bg_width=128,             # width of the colors MLP_bg
